		...
		if (FarsiType.Type) {
			...
			if (key > 128) {
				if (FarsiType.KeyBoardError == 0) {
                    ...
                    swal(
                        'توجه!',
                        'لطفا زبان صفحه کلید را به حالت انگلیسی برگردانید',
                        'warning'
                    );
                   // alert("لطفا زبان صفحه کلید را به حالت انگلیسی برگردانید.");
					return false;
				}
			}
			...
			if (FarsiType.Type && z.farsi) {
				...
				if ((key >= 65 && key <= 90&& !e.shiftKey) || (key >= 97 && key <= 122 ) && e.shiftKey) {
                    swal(
                        'توجه!',
                        'صفحه کلید در حالت Caps Lock روشن قرار دارد، لطفا Caps Lock را خاموش کنید.',
                        'warning'
                    );
                   // alert("");
					return false;
