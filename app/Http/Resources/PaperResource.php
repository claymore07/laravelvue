        ...
        if($request->is('api/paper')||$request->is('api/findPaper')) {
            ...
            if($this->paperable_type == 'App\Models\Journal'){
                ...
                $resource = [
                    ...
                    'volume' => $this->paperable->volume != null ? $this->paperable->volume : '-',
                    'pages' => $this->paperable->pages != null ? $this->paperable->pages : '-',
                    'issue' => $this->paperable->issue != null ? $this->paperable->issue : '-',
                    'IFactor' => $this->paperable->IFactor != null ? $this->paperable->IFactor : '-',
                    'FIF' => $this->paperable->FIF != null ? $this->paperable->FIF : '-',
                    'scopus' => $this->paperable->scopus != null ? $this->paperable->scopus : '-',
                ...
                $resource = [
                    ...
                    'presentation_type' => $this->paperable->presentation_type,
