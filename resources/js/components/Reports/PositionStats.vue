                ...
                <div class="card-header  " style="direction: rtl">
                    <div class="row justify-content-between  text-right">
                        <div class="col-xl-4 m-3">
                            <h4 class=" text-right"><i class="fal fa-file-chart-line fa-fw"></i>گزارش نموداری براساس نوع همکاری</h4>
                        </div>
                    </div><!-- /card-tools -->
    ...
    export default {
        ...
        methods:{
            changeDate(type){
                if(type === 0){
                    this.radialchartOptions = {...this.radialchartOptions,...{
                            title: {
                                text: `نمودار درصد  ${this.chartTitle} پذیرفته شده براساس نوع همکاری`,
                                align: 'center'
                            },
                        }};
                    ...
                    this.radialchartOptions = {...this.radialchartOptions,...{
                            title: {
                                text: `نمودار درصد  ${this.chartTitle} بررسی نشده براساس نوع همکاری`,
                                align: 'center'
                            },
                        }};
                    ...
                    this.radialchartOptions = {...this.radialchartOptions,...{
                            title: {
                                text: `نمودار درصد  ${this.chartTitle} تایید نشده براساس نوع همکاری`,
                                align: 'center'
                            },
                        }};
            ...
            getResults(){
                ...
                axios.post('/api/positionStats?term_id=' + this.term_id +
                    '&start_date=' + this.start_date + '&end_date=' + this.end_date + '&query_type=' + this.query_type )
                    .then(response => {
                        loader1.hide();
                        this.options = {...this.options,...{
                                title: {
                                    text: `نمودار وضعیت رسیدگی به ${this.chartTitle} براساس نوع همکاری`,
                                    align: 'center'
                                },
                                xaxis: {
