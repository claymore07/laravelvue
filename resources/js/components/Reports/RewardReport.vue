                    ...
                    <div class="card-header  " style="direction: rtl">
                        <div class="row justify-content-between  text-right">
                            <div class="col-xl-4 m-3">
                                <h4 class=" text-right"><i class="fal fa-file-chart-line fa-fw"></i>گزارش جوایز</h4>
                            </div>
                        </div><!-- /card-tools -->
                            ...
                            <table class="table  table-striped table-hover text-right">
                                ...
                                <tr v-for="(reward, index) in rewards" :key="reward.id">
                                    ...
                                    <td><span v-if="reward.place == 1" class="mr-3">رتبه اول</span>
                                        ...
                                        <span v-else-if="reward.place == 3" class="mr-3">رتبه سوم</span></td>
                                    <td>{{ reward.period | faDigits }}</td>
                                    ...
                                    <td colspan="2">{{ reward.created_at | myDate  }}</td>
    ...
    export default {
        ...
        data(){
            return{
                ...
                total: 0,       // total number of rewards
                numToShow: 0,   // number of rewards shown in this page
        ...
        created() {
            this.$parent.pageName = 'گزارش جوایز';
            Fire.$on('searching', () => {
                let page = 1;
