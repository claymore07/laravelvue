                ...
                <div class="card card-4">
                    <div class="card-header  " style="direction: rtl">
                        <div class="row justify-content-between  text-right">
                            <div class="col-xl-4 m-3">
                                <h4 class=" text-right"><i class="fal fa-file-chart-line fa-fw"></i>گزارش طرح های پژوهشی</h4>
                            </div>
                        </div><!-- /card-tools -->
                    ...
                    <div class="card-body  p-4">
                        ...
                        <div class="row justify-content-start no-gutters mt-3">
                            ...
                            <div  class="col-lg-3  mt-3 mr-2" >
                                <div class="form-group mb-3 text-right">
                                    <label class="blue text-right  text-rtl">نوع طرح پژوهشی :</label>
                                    <!-- @change="searchit" -->
                                    <select  v-model="project_type_id" class="custom-select">
                                        <option selected value="0">تمام طرح ها</option>
                                        <option v-for="project_type in project_types" :value="project_type.id" :key="project_type.id">{{project_type.text}}</option>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div v-if="showReport" class="card-body table-responsive p-0 table-sm my-5">
                            ...
                            <table class="table  table-striped table-hover text-right">
                                ...
                                <tr v-for="(project, index) in projects" :key="project.id">
                                    ...
                                    <td>{{ project.council_aprovedate  | myDate  }}</td>
                                    ...
                                    <td colspan="2">{{ project.created_at | myDate  }}</td>
    ...
    export default {
        ...
        data(){
            return{
                ...
                total: 0,       // total number of projects
                numToShow: 0,   // number of projects shown in this page
                ...
                project_fields:{
                    ...
                    'سازمان طرف قرارداد' : 'organization',
        ...
        created() {
            this.$parent.pageName = 'گزارش طرح های پژوهشی';
            Fire.$on('searching', () => {
                let page = 1;
