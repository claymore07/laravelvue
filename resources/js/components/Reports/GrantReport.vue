                    ...
                    <div class="card-header  " style="direction: rtl">
                        <div class="row justify-content-between  text-right">
                            <div class="col-xl-4 m-3">
                                <h4 class=" text-right"><i class="fal fa-file-chart-line fa-fw"></i>گزارش بودجه های جذب شده</h4>
                            </div>
                        </div><!-- /card-tools -->
                        ...
                        <div v-if="showReport" class="card-body table-responsive p-0 table-sm my-5">
                            ...
                            <table class="table  table-striped table-hover text-right">
                                ...
                                <tr v-for="(grant, index) in grants" :key="grant.id">
                                    ...
                                    <td  class="persian-num">{{ grant.budget | currency }}
                                    ...
                                    <td colspan="2">{{ grant.created_at | myDate  }}</td>
    ...
    export default {
        ...
        data(){
            return{
                ...
                total: 0,       // total number of grants
                numToShow: 0,   // number of grants shown in this page
        ...
        created() {
            this.$parent.pageName = 'گزارش گرنت های جذب شده';
            Fire.$on('searching', () => {
                let page = 1;
