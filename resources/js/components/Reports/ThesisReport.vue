                        ...
                        <div class="row justify-content-start no-gutters mt-3">
                            ...
                            <div  class="col-lg-3  mt-3 mr-2" >
                                <div class="form-group mb-3 text-right">
                                    ...
                                    <!-- @change="searchit" -->
                                    <select  v-model="thesis_type_id" class="custom-select">
                                        <option selected value="0">تمام پایان نامه ها</option>
                                        <option v-for="theses_type in theses_types" :value="theses_type.id" :key="theses_type.id">{{theses_type.text}}</option>
                                    </select>
                                </div>
                            </div>
