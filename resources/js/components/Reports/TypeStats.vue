                ...
                <div class="card-header  " style="direction: rtl">
                    <div class="row justify-content-between  text-right">
                        <div class="col-xl-4 m-3">
                            <h4 class=" text-right"><i class="fal fa-file-chart-line fa-fw"></i>گزارش نموداری براساس نوع آثار</h4>
                        </div>
                    </div><!-- /card-tools -->
    ...
    export default {
        ...
        methods:{
            changeDate(type){
                if(type === 0){
                    this.radialchartOptions = {...this.radialchartOptions,...{
                            title: {
                                text: `نمودار درصد پذیرفته شده براساس نوع ${this.chartTitle}`,
                                align: 'center'
                            },
                        }};
                    ...
                    this.radialchartOptions = {...this.radialchartOptions,...{
                            title: {
                                text: `نمودار درصد بررسی نشده براساس نوع ${this.chartTitle}`,
                                align: 'center'
                            },
                        }};
                    ...
                    this.radialchartOptions = {...this.radialchartOptions,...{
                            title: {
                                text: `نمودار درصد تایید نشده براساس نوع ${this.chartTitle}`,
                                align: 'center'
                            },
                        }};
            ...
            getResults(){
                ...
                axios.post('/api/typesStats?term_id=' + this.term_id +
        ...
        created(){
            this.$parent.pageName = 'گزارش نموداری براساس نوع آثار';
            this.getTermsList();
        },
        components: {
            Select2,
