        ...
        methods:{
            ...
            getResults: function (page = 1, que = '') {
                ...
                if (this.searchResult) {
                    que = this.search;
                    axios.get('/api/findBooklet?order=' + sortOrder + '&q=' + que + '&filter=' + this.filter
                    ...
                    axios.get('/api/booklet?order=' + sortOrder + '&page=' + page +
            ...
            prepareRegulation() {
                axios.get(`/api/regulationDetail/11`).then((response)=>{
