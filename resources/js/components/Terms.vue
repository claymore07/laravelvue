                    ...
                    <div class="justify-content-around d-md-flex text-right">
                        ...
                        <div class="col-md-3 mt-3">
                            <div class="d-md-inline-block float-md-left">
                                <button class="btn btn-success" @click="newModal"><i style="font-size: 16px" class="fal  fa-plus-square"></i> تعریف ترم</button>
                            </div>
                        </div>
                    </div><!-- /card-tools -->
                </div><!-- /.card-header -->
                <div class="card-body table-responsive p-0">
                    ...
                    <table class="table table-hover text-right">
                        ...
                        <tr v-for="(term, index) in terms.data" :key="term.id">
                            ...
                            <td>
                                <a class="btn btn-success" href="#" @click="termActivate(term.id)" title="فعالسازی ترم">
