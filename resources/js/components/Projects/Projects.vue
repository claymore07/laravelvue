                    ...
                    <div class="card-header  " style="direction: rtl">
                        <div class="justify-content-around d-lg-flex text-right">
                            <div class="col-lg-2 m-3">
                                <h4 class=" text-right"><i class="fal fa-project-diagram fa-fw"></i> طرح‌های پژوهشی</h4>
                            </div>
                            ...
                            <div class="col-lg-5  mt-3" >
                                <div class="d-xl-inline-block  ">
                                    <div class="input-group mb-3 ">
                                        <select v-model="filter" @change="searchit" class="custom-select">
                                            <option selecproject disabled>پالایش بر اساس:</option>
                                ...
                                <div class="d-xl-inline-block float-xl-left">
                                    <button class="btn btn-success ripple " @click="newModal">
                                        <i style="font-size: 16px" class="fal fa-file-plus"></i> افزودن طرح پژوهشی</button>
                                </div>
                            </div>
                        </div><!-- /card-tools -->
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel"><i
                                class="fas fa-project-diagram fa-fw"></i> ثبت طرح‌ پژوهشی جدید </h5>
