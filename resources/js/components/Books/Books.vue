                        ...
                        <div class="justify-content-around d-lg-flex text-right">
                            ...
                            <div class="col-lg-5  mt-3" >
                                ...
                                <div class="d-xl-inline-block float-xl-left">
                                    <button class="btn btn-success ripple " @click="newModal"><i style="font-size: 16px" class="fal fa-file-plus"></i> افزودن کتاب</button>
                                </div>
                            </div>
                        </div><!-- /card-tools -->
        ...
        methods:{
            ...
            getResults(page = 1, que = '') {
                ...
                if (this.searchResult) {
                    que = this.search;
                    axios.get('/api/findBook?order=' + sortOrder + '&q=' + que +'&filter='+this.filter +'&page=' + page)
                        .then(response => {
                            loader1.hide();
                    ...
                    axios.get('/api/book?order=' + sortOrder + '&page=' + page +'&filter='+this.filter)
                        .then(response => {
                            loader1.hide();
                            this.allData = response.data;
                            this.books = response.data.data;
