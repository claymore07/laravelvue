<template>
    <div>
                    ...
                    <table class="table table-hover table-striped">
                        ...
                        <tr>
                            <td class="font-16">
                                ...
                                <span class="red float-left font-20" v-if="checkListForm.list && checkListForm.list.includes('عنوان اثر‌')" title="عدم تایید"><i @click="checkListHistory"  class="fa fa-times-circle fe-pulse-w-pause "></i></span>
                            </td>
                            <td v-if="checkList">
                        ...
                        <tr>
                            <td class="font-16">
                                ...
                                <span class="red float-left font-20" v-if="checkListForm.list && checkListForm.list.includes('نوع اثر‌')" title="عدم تایید"><i @click="checkListHistory"  class="fa fa-times-circle fe-pulse-w-pause "></i></span>
                            </td>
                            <td v-if="checkList">
                        ...
                        <tr>
                            <td class="font-16">
                                ...
                                <span class="red float-left font-20" v-if="checkListForm.list && checkListForm.list.includes('نام داور')" title="عدم تایید"><i @click="checkListHistory"  class="fa fa-times-circle fe-pulse-w-pause "></i></span>
                            </td>
                            <td v-if="checkList">
                        ...
                        <tr v-if="journalFields">
                            <td class="font-16">
                                ...
                                <span class="red float-left font-20" v-if="checkListForm.list && checkListForm.list.includes('شماره ISSN')" title="عدم تایید"><i @click="checkListHistory"  class="fa fa-times-circle fe-pulse-w-pause "></i></span>
                            </td>
                            <td v-if="checkList">
                        ...
                        <tr>
                            <td class="font-16">
                                ...
                                <span class="red float-left font-20" v-if="checkListForm.list && checkListForm.list.includes('تاریخ داوری')" title="عدم تایید"><i @click="checkListHistory"  class="fa fa-times-circle fe-pulse-w-pause "></i></span>
                            </td>
                            <td v-if="checkList">
                                <p-check
                        ...
                        <tr>
                            <td class="font-16">
                                ...
                                <span v-show="!TermChange" class="mr-3 persian-num">{{referee.term_name}}</span>
                        ...
                        <tr>
                            <td class="font-16">
                                ...
                                <span v-if="referee.status != '1'"  ><i class="fal fa-question"></i>  {{'امتیازی ثبت نشده' }}</span>
                                <span v-else class="persian-num">  {{referee.score  }}</span>
                            </td>
                            <td v-if="checkList">
                            </td>
                        </tr>
                        ...
                        <tr  v-show="checkList && checkListForm.status == 1">
                            <td colspan="2">
                                <form  data-vv-scope="checkListForm">
                                    <div v-if="" class="form-inline">
                                        <div class="form-group w-25 text-right">
                                            <label class="blue ml-3">امتیاز:</label>
                                            <input type="number" :min="referee.minScore" :max="referee.maxScore" name="score"
                                                   placeholder=""
                                                   :class="[( errors.has('checkListForm.score') || checkListForm.errors.has('score') ? 'is-invalid': ''  )]"
                                                   v-validate="{min_value:referee.minScore,max_value:referee.maxScore}"
                                                   class="form-control w-50" v-model="checkListForm.score" >
                                        </div>
                                        <div class="form-group mb-2">
                                            <span class="persian-num">توجه: امتیاز این آیتم با توجه به بخشنامه در بازه {{referee.minScore}} و {{referee.maxScore}} در نظر گرفته میشود.</span>
                                        </div>
                                    </div>
        ...
        <div   class="modal  fade" id="refereeEditModal" tabindex="-1" role="dialog" aria-labelledby="addNewLabel" aria-hidden="true">
    ...
    export default {
        ...
        methods:{
            ...
            prepareCheckList(){
                ...
                this.checkListForm.score = this.referee.score;
            },
            toggleCheckList(){
            ...
            getRefereeData(id){
                axios.get(`/api/referee/${id}`)
                    .then(response => {
                        this.referee = response.data.data;
                        this.checkListItems = response.data.data.checkList;
                        this.term_form.term_id = this.referee.term_id;
            ...
            termChangeSubmit(){
                ...
                this.term_form.post('/api/termChange')
                    .then((res)=>{
                        loader1.hide();
                        this.referee.term_name = res.data.term_name;
                        this.referee.term_id = res.data.term_id;
