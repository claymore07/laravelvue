                    ...
                    <div class="justify-content-around d-lg-flex text-right">
                        ...
                        <div class="col-lg-3  mt-3" >
                            <div class="d-xl-inline-block float-xl-left">
                                <button class="btn ripple btn-success" @click="newModal"><i style="font-size: 16px" class="fal  fa-plus-square"></i> افزودن دانشکده</button>
                            </div>
                        </div>
                    </div><!-- /card-tools -->
            ...
            <div class="modal-dialog modal-xl  modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" v-if="!editMode" id="exampleModalLabel22"><i
                            class="fas fa-university fa-fw"></i> ایجاد دانشکده جدید</h5>
                        <h5 class="modal-title" v-else="editMode" id="exampleModalLabel33"><i
                    ...
                    <form @submit.prevent="editMode ? updateFaculty():createFaculty()" @keydown="form.onKeydown($event)" @change="form.onKeydown($event)" id="Form">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-danger btn-lg btn-block ripple mt-0" data-dismiss="modal">لغو عملیات</button>
                        </div>
                    </form>
                </div><!-- /modal-content -->
            </div><!-- /modal-dialog -->
