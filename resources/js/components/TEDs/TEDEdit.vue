<template>
    <div>
                    ...
                    <table class="table table-hover table-striped">
                        ...
                        <tr>
                            <td class="font-16">
                                ...
                                <span v-show="!TermChange" class="mr-3 persian-num">{{ted.term_name}}</span>
                        ...
                        <tr>
                            <td class="font-16">
                                ...
                                <span v-else class="persian-num">  {{ted.score  }}</span>
                            </td>
                            <td v-if="checkList">
                            </td>
                        </tr>
                                ...
                                <form  data-vv-scope="checkListForm">
                                    <div  class="form-inline">
                                        ...
                                        <div class="form-group mb-2">
                                            <span class="persian-num">توجه: امتیاز این آیتم با توجه به بخشنامه در بازه {{ted.minScore}} و {{ted.maxScore}} در نظر گرفته میشود.</span>
                                        </div>
                                    </div>
        ...
        <div   class="modal  fade" id="tedEditModal" tabindex="-1" role="dialog" aria-labelledby="addNewLabel" aria-hidden="true">
