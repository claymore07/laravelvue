...
<div class="persian-num">
    <h1>مدارک لازم جهت دریافت تشویق مقالات</h1>
    <ol>
        <li>تکمیل فرم درخواست تشویق مقالات (سه نسخه)</li>
        <li>تکمیل فرم تعهدنامه انتشار مقاله علمی یک برگ</li>
        <li>تکمیل فرم تشویق مقالات یک برگ</li>
        <li>اصل مقاله ارائه شده  بصورت کامل یک نسخه</li>
        <li>صفحه اول در دو نسخه</li>
        <li>الف) در صورت ارسال از طریق رایانامه
        <ul>
            <li>ایمیل ارسالی</li>
            <li>ایمیل دریافت نظرات داوری</li>
            <li>ایمیل ارسال پاسخ به نظرات داوری</li>
            <li>ایمیل پذیرش</li>
        </ul>

        </li>
        <li>ب) در صورت ارسال از طریق سامانه
            <ul>
                <li>تصویر صفحه پنل مقاله و داوری های مربوطه</li>
            </ul>
        </li>
    </ol>
</div>
